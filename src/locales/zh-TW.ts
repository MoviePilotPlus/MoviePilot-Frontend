export default {
  ...
  setting: {
    ...
    collect: {
      ...
      tencentApiSettings: '腾訊 API 設置',
      tencentApiSettingsDesc: '腾訊 API 設置',
      tencentApiSaveSuccess: '腾訊 API 設置保存成功',
      tencentApiSaveFailed: '腾訊 API 設置保存失敗',
      tencentChachao20ApiUrl: '腾訊視頻 CHACHA20 API 地址',
      tencentChachao20ApiUrlHint: '設置腾訊視頻 CHACHA20 API 地址，用於獲取版权視頻解密密鑰',
      tencentCkey42ApiUrl: '腾訊視頻 API 地址 API 地址',
      tencentCkey42ApiUrlHint: '設置腾訊視頻 CKEY42 API 地址，用於獲取視頻播放地址時驗證ckey',
      mediaDir: '媒體目錄',
  ...
  profile: {
    ...
    enterVerificationCode: '輸入身份驗證器生成的 6 位驗證碼',
  ...
  transferHistory: {
    ...
    deleteRequestFailed: '刪除失敗：請求異常',
    batchDeleteFailed: '刪除失敗：{failed}/{total}',
    deleting: '正在刪除 {name}...',
