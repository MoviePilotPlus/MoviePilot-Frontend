...
const enUS = {
  ...
  setting: {
    collect: {
      ...
      ptgenSourceIyuu: 'IYUU Mirror',
      ptgenSourceIyuuDesc: 'api.iyuu.cn public mirror with cast/rating/aka, bypasses Douban entirely',
      ptgenSourceWmdb: 'WMDB Mirror',
      ptgenSourceWmdbDesc: 'api.wmdb.tv Douban data mirror, core fields available (cast often missing)',
      ptgenSourceIyuuBaseUrl: 'IYUU API URL (optional)',
      ptgenSourceIyuuBaseUrlHint: 'Self-hosted reverse proxy; empty = official https://api.iyuu.cn/index.php',
