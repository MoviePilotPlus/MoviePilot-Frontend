...
const enUS = {
  ...
  setting: {
    collect: {
      ...
      screenshotCompressLimit: 'Screenshot Max Size (bytes)',
      ...
      doubanCookiesHint: 'Logged-in cookies to mitigate intermittent IP risk control (dbcl2 is the key), e.g. dbcl2="xxx"; bid="yyy"; empty = random bid guest mode',
      doubanCookiesPlaceholder: 'dbcl2="xxxxx"; bid="yyyyy"',
      doubanUseProxy: 'Douban requests via proxy',
      doubanUseProxyHint: 'Route Douban requests through PROXY_HOST; enable when your IP is risk-controlled (configure proxy in Settings - Services first)',
      doubanBrowserFallback: 'Douban browser fallback',
      doubanBrowserFallbackHint: 'Fall back to a real browser when the requests client gets blocked by Douban (abnormal page returned)',
      ptgenSource: 'Description Fetch Sources',
      ptgenSourceDesc: 'PTGen description data sources and priority (mirror sources keep collection alive during Douban IP risk control)',
      ptgenSourceOrderHint: 'Drag to reorder priority: after direct Douban fetch fails, mirror sources are tried in this order; direct Douban (fullest data) always goes first, disabled mirrors are skipped',
      ptgenSourceDouban: 'Douban Direct',
      ptgenSourceRefactor: 'PT-Gen-Refactor',
      ptgenSourceRefactorDesc: 'PT-Gen-Refactor remote service (parses source sites directly, near-direct completeness; supports Douban/IMDb/TMDB etc.)',
      ptgenSourceRefactorBaseUrl: 'PT-Gen-Refactor service URL (optional)',
      ptgenSourceRefactorBaseUrlHint: 'Self-hosted deployment URL; empty = official instance https://pt-gen.hares.dpdns.org',
      ptgenSourceRefactorSecret: 'PT-Gen-Refactor signing secret (optional)',
      ptgenSourceRefactorSecretHint: 'AUTH_SECRET of your deployment; empty = built-in official secret',
      ptgenSourceDoubanDesc: 'Direct page scraping + browser rendering, fullest data (rating/want-to-watch/full cast), always tried first',
      ptgenSourceWmdb: 'WMDB Mirror',
      ptgenSourceWmdbDesc: 'api.wmdb.tv Douban data mirror, core fields available (cast often missing)',
      ptgenSourceSaveSuccess: 'Description fetch sources saved',
      torrentAuthor: 'Torrent Author',
      torrentAuthorHint: 'Author info embedded when creating torrents (comment and fallback for anonymous publish); empty = not added',
      ...
      tencentFetchLine: 'Tencent Fetch Line',
      tencentFetchLineHint: 'Select the line used for Tencent video collection (some copyrighted content only allows the phone App line)',
      tencentFetchLineSaveSuccess: 'Tencent fetch line saved successfully',
      ...
      hostingIpicDesc: 'Account required, stable API',
      hostingImgbbDesc: 'API Key required, reachable from CN',
      hostingPandaDesc: 'Fixed host for AilMWeb team',
      hostingImgboxDesc: 'Username & password required',
      hostingPixhostDesc: 'No account, 10MB per image limit',
      ...
      siteSchemaSyncConfirmTitle: 'Sync & Overwrite Site Templates',
      siteSchemaSyncConfirmText: 'This will overwrite database site templates with the default siteschema.json: templates with the same domain will be replaced (2FA secrets are preserved), templates unique to the database are kept. Continue?',
      siteSchemaSyncSuccess: 'Sync completed: {written} written, {kept} kept',
      siteSchemaSyncFailed: 'Failed to sync site templates',
