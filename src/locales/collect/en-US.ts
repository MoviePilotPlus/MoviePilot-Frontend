...
const enUS = {
  ...
  setting: {
    collect: {
      ...
      ptgenSourceOrderHint: 'Drag to reorder priority; sources are tried in this order and disabled ones are skipped (disabling Douban Direct also skips browser rendering)',
      ...
      ptgenSourceDoubanDesc: 'Direct page scraping + browser rendering, fullest data (rating/want-to-watch/full cast)',
      ...
      hostingIpicDesc: 'No account, built-in integration',
