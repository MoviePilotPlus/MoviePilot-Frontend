...
const zhTW = {
  ...
  setting: {
    collect: {
      ...
      ptgenSourceIyuu: 'IYUU 鏡像',
      ptgenSourceIyuuDesc: 'api.iyuu.cn 公共鏡像，演職員/評分/別名齊全，不經豆瓣出口',
      ptgenSourceWmdb: 'WMDB 鏡像',
      ptgenSourceWmdbDesc: 'api.wmdb.tv 豆瓣資料鏡像，核心欄位可用（演員表常缺）',
      ptgenSourceIyuuBaseUrl: 'IYUU 介面地址（可選）',
      ptgenSourceIyuuBaseUrlHint: '自建反代地址；留空用官方 https://api.iyuu.cn/index.php',
